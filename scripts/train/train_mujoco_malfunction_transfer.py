...
def parse_args(args, parser):
    ...
    parser.add_argument("--mal_agent_old", type=int, default=0)
    parser.add_argument("--mal_agent_new", type=int, default=0)
...
def main(args):
    ...
    run_dir = Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[
                       0] + f"/results/malfunction/{all_args.mal_agent_old}{all_args.mal_agent_new}") / all_args.env_name / all_args.scenario / all_args.algorithm_name / all_args.experiment_name / str(all_args.seed)
    ...
    mal_agent_old = all_args.mal_agent_old
    mal_agent_new = all_args.mal_agent_new
    mal_episode = all_args.mal_episode

    # run experiments
    runner = Runner(config)
    runner.run(malfunction, mal_episode, mal_agent_old, mal_agent_new)
